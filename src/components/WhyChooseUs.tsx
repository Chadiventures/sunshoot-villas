...
export default function WhyChooseUs() {
  ...
  const features = useMemo(
    () => [
      {
        key: "location",
        title: t.whyChooseUsLocationTitle,
        mobileTitle: t.whyChooseUsLocationMobileTitle,
        description: t.whyChooseUsLocationDescription,
        icon: FEATURE_ICONS[0],
      },
      {
        key: "pool",
        title: t.whyChooseUsPoolTitle,
        mobileTitle: t.whyChooseUsPoolMobileTitle,
        description: t.whyChooseUsPoolDescription,
        icon: FEATURE_ICONS[1],
      },
      {
        key: "service",
        title: t.whyChooseUsServiceTitle,
        mobileTitle: t.whyChooseUsServiceMobileTitle,
        description: t.whyChooseUsServiceDescription,
        icon: FEATURE_ICONS[2],
      },
      {
        key: "pickup",
        title: t.whyChooseUsPickupTitle,
        mobileTitle: t.whyChooseUsPickupMobileTitle,
        description: t.whyChooseUsPickupDescription,
