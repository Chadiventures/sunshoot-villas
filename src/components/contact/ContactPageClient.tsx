          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <p className="section-eyebrow mb-1">{t.contactLabelPhone}</p>
                  <a
                ...
                <div>
                  <p className="section-eyebrow mb-1">{t.contactLabelEmail}</p>
                  <a
                ...
                <div>
                  <p className="section-eyebrow mb-1">{t.contactLabelAddress}</p>
                  <p
                ...
                <div>
                  <p className="section-eyebrow mb-1">{t.contactLabelWhatsApp}</p>
                  <a
